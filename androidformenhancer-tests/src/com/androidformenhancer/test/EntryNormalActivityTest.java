...
public class EntryNormalActivityTest extends ActivityInstrumentationTestCase2<EntryNormalActivity> {

    private EntryNormalActivity activity;

    public EntryNormalActivityTest() {
        super(EntryNormalActivity.class);
    }
